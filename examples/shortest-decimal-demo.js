...
console.log(`Offset notation: [+0.5:-0.6] means +0.5×0.01 and -0.6×0.01`);
...
console.log(`Offset notation: [+-2.5] means ±2.5×0.01 = ±0.025\n`);
...
console.log(`Offset notation: [+-0.5] means ±0.5×0.01 = ±0.005\n`);
...
console.log(`Offset notation: [+8.3:-7.3] uses the integer base unit, 1`);
...
console.log(`Offset notation: [+-1] means ±1×0.01 = ±0.01`);
...
console.log('• Offsets: Use the base number’s last visible digit as their unit');
