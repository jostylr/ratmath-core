...
import { Rational, RationalInterval } from '../src/index.js';
...
describe('RationalInterval', () => {
  ...
  describe('arithmetic operations', () => {
    ...
    it('throws an error when dividing by an interval containing zero', () => {
      ...
      expect(() => a.divide(b)).toThrow('Cannot divide by an interval containing zero');
    });
  });
  ...
  describe('static constants', () => {
    ...
    it('provides a unit interval constant', () => {
      expect(RationalInterval.unitInterval.low.equals(Rational.zero)).toBe(true);
      expect(RationalInterval.unitInterval.high.equals(Rational.one)).toBe(true);
    });
  });
  ...
  describe('exponentiation', () => {
    ...
    it('throws an error when raising zero to power 0', () => {
      ...
      expect(() => interval.pow(0)).toThrow('Zero cannot be raised to the power of zero');
    });

    it('throws an error when raising an interval containing zero to power 0', () => {
      const interval = new RationalInterval('-1/2', '1/2');
      
      expect(() => interval.pow(0)).toThrow('Cannot raise an interval containing zero to the power of zero');
    });

    it('throws an error when raising an interval containing zero to a negative power', () => {
      const interval = new RationalInterval('-1/2', '1/2');
      
      expect(() => interval.pow(-1)).toThrow('Cannot raise an interval containing zero to a negative power');
    });
  });
  ...
  describe('multiplicative exponentiation', () => {
    ...
    it('throws an error for exponent 0', () => {
      ...
      expect(() => interval.mpow(0)).toThrow('Multiplicative exponentiation requires at least one factor');
    });
  });
  ...
  describe('negation and reciprocation', () => {
    ...
    it('throws an error when reciprocating an interval containing zero', () => {
      ...
      expect(() => interval.reciprocate()).toThrow('Cannot reciprocate an interval containing zero');
    });
  });
  ...
  describe('static methods', () => {
    ...
    it('throws an error for invalid string format', () => {
      expect(() => RationalInterval.fromString('1/2')).toThrow('Invalid interval format');
    });
  });
});