...
import { Parser, Rational, RationalInterval } from '../src/index.js';
...
describe('Parser', () => {
  ...
  describe('multiplicative power', () => {
    ...
    it('throws an error for zero exponent with ** operator', () => {
      expect(() => Parser.parse('2**0')).toThrow('Multiplicative exponentiation requires at least one factor');
    });
  });
  ...
  describe('error handling', () => {
    ...
    it('throws an error for raising zero to power zero', () => {
      expect(() => Parser.parse('0^0')).toThrow('Zero cannot be raised to the power of zero');
    });
